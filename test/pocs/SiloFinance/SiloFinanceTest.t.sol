...
/** 
    This case is fail case when Exploiter direct call to ISilo(borrow())
    The exploit will fail because the ISilo contract has a check to prevent
    unauthorized(amount of approve is insufficient) users from borrowing assets.
*/
...
contract SiloFinanceExploit {
    ...
    function attack() external {
        exchangeProxySilo.borrow(224e18, exploiter, victimAddress);
    }
